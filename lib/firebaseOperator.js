...
/**
 * True if Operator client config is missing (e.g. env vars not set at build time).
 * Use in the browser to show a helpful message.
 */
export function isOperatorConfigMissing() {
  if (typeof window === "undefined") return true;
  return !operatorConfig.apiKey || !operatorConfig.projectId;
}
